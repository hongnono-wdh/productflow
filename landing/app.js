...
(function () {
  ...
  var STAGES = [
    ...
    { n: "06", tag: "看板", title: "开发实现", desc: "脚手架、Web 全栈 / 原生 App / 桌面应用，TDD 测试，实现界面对着设计稿一一比对。",
      art: '<div class="art-row"><span class="art-chip">前端</span><span class="art-chip">后端</span><span class="art-chip ok">TDD 通过 ✓</span></div>' },
    { n: "07", tag: "看板", title: "部署上线", desc: "Web 走 Docker / Cloudflare / 单机，iOS 上 TestFlight、Android 上 Google Play，PC 桌面应用打包安装包，上线即出交付报告。",
